...
// Validate checks the field values on URLConfig with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *URLConfig) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on URLConfig with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in URLConfigMultiError, or nil
// if none found.
func (m *URLConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *URLConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// URLConfigMultiError is an error wrapping multiple validation errors returned
// by URLConfig.ValidateAll() if the designated constraints aren't met.
type URLConfigMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m URLConfigMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m URLConfigMultiError) AllErrors() []error { return m }

// URLConfigValidationError is the validation error returned by
// URLConfig.Validate if the designated constraints aren't met.
type URLConfigValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e URLConfigValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e URLConfigValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e URLConfigValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e URLConfigValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e URLConfigValidationError) ErrorName() string { return "URLConfigValidationError" }

// Error satisfies the builtin error interface
func (e URLConfigValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = URLConfigValidationError{}
